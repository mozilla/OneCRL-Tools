...
def ccadb_import(event, context):
    ...
    exit_code = subprocess.call([lambda_task_root + '/salesforce2OneCRL', '--exceptions', 'https://raw.githubusercontent.com/mozilla/OneCRL-Tools/master/salesforce2OneCRL/data/exceptions.json'], env=os.environ.copy())
    if exit_code > 0:
